...
class AddRecipe extends React.Component {
  defaults = require("../lib/data/recipeDefaults.json");
  state = {
    loading: false,
    cookingTime: "",
    cuisine: "",
      ...
      <div>
        ...
        >
          <div className="add-recipe-middle-wrapper">
            ...
            {recipeInputDropdown(
              "Ingredient Count",
              this.defaults.ingredientCount,
              this.setRecipeIngredientCount,
              this.ingredientCount
            )}
            {recipeInput("Directions", "Cook this", this.setRecipeDirections)}
            {recipeInputDropdown(
              "Cooking Time",
              this.defaults.cookingTime,
              this.setRecipeCookingTime,
              this.cookingTime
            )}
            {recipeInputDropdown(
              "Difficulty",
              this.defaults.difficulty,
              this.setRecipeDifficulty,
              this.difficulty
            )}
            {recipeInputDropdown(
              "Cuisine",
              this.defaults.cuisine,
              this.setRecipeCuisine,
              this.cuisine
            )}
            {recipeInputDropdown(
              "Diet",
            ...
            <button className="recipe-submit" onClick={this.createRecipe}>
              Create Recipe
            </button>
          </div>
        </div>
