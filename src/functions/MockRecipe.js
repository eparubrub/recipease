const MockRecipe = () => {
  ...
  return {
    ...
    difficulty: defaults.difficulty[Math.floor(Math.random() * defaults.difficulty.length)],
    directions: testdata.directions[Math.floor(Math.random() * testdata.directions.length)],
    id: recipeId,
